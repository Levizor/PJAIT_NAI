...
public class Config {
    ...
    public Config(ArrayList<Value> train, ArrayList<Value> test, double alpha, int dimension) {
        this.train = train;
        this.test = test;
        this.alpha = alpha;
    ...
    public static Config fromArgs(String[] args) {
        ...
        double alpha = cliParser.getAlpha();
        ...
        return new Config( train, test, cliParser.getAlpha(), dimension);
    }
